...
def get_args():
    ...
    parser.add_argument("--query_path", default = "./data/queries.txt", type = str, help = "Path of the query file, each line is a query.")
    parser.add_argument("--secret_path", default = "./data/secrets.txt", type = str, help = "Path of the OpenAI and LangChain secret file.")
